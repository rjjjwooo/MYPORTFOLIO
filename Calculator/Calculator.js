			...
			class Canvas {
				...
				setting(targetDom) {
					...
					(e)=>{
						e = e? e:event;
						switch(e.target.id){
							case "oneFunction": cheak.one = true; this.oneFunctionCheak(functionValue.a1,functionValue.b1,0,0); break; //1차 함수 실행
							case "twoFunction": cheak.two = true; this.twoFunctionCheak(functionValue.a2,functionValue.b2,functionValue.c2,0,0); break;// 2차 함수 실행
							case "threeFunction": cheak.three = true; this.threeFunctionCheak(functionValue.a3,functionValue.b3,functionValue.c3,functionValue.d3,0,0); break;// 3차 함수 실행
							case "circleFunction": cheak.circle = true; this.circleFunctionCheak(functionValue.a4,functionValue.b4,functionValue.r4,0,0); break; // 원 함수 실행
						...
						if(e.target.id === "zoomIn"){
							...
							cleargo();
							if( cheak.one ){ this.oneFunctionCheak(functionValue.a1,functionValue.b1,0,0); }
							if( cheak.two){ this.twoFunctionCheak(functionValue.a2,functionValue.b2,functionValue.c2,0,0); }
							if( cheak.three ){ this.threeFunctionCheak(functionValue.a3,functionValue.b3,functionValue.c3,functionValue.d3,0,0); }
							if( cheak.circle ){ this.circleFunctionCheak(functionValue.a4,functionValue.b4,functionValue.r4,0,0); }
							this.gradation(0,0);
							
						}
						if(e.target.id === "closeIn"){
							this.scale -= 10;
							if(this.scale === 10) { this.scale = 20;}
							cleargo();
							if( cheak.one ){ this.oneFunctionCheak(functionValue.a1,functionValue.b1,0,0); }
							if( cheak.two){ this.twoFunctionCheak(functionValue.a2,functionValue.b2,functionValue.c2,0,0); }
							if( cheak.three ){ this.threeFunctionCheak(functionValue.a3,functionValue.b3,functionValue.c3,functionValue.d3,0,0); }
						...
						if(e.target.id === "up"){//up 그리기
							...
							if( cheak.one ){ this.oneFunctionCheak(functionValue.a1,functionValue.b1,functionValue.rightPorint,functionValue.upPoint); } 
							if( cheak.two){ this.twoFunctionCheak(functionValue.a2,functionValue.b2,functionValue.c2,functionValue.rightPorint,functionValue.upPoint); }
							if( cheak.three ){ this.threeFunctionCheak(functionValue.a3,functionValue.b3,functionValue.c3,functionValue.d3,functionValue.rightPorint,functionValue.upPoint); }
							if( cheak.circle ){ this.circleFunctionCheak(functionValue.a4,functionValue.b4,functionValue.r4,functionValue.rightPorint,functionValue.upPoint); }
				...
				gradation(item1,item2) {
					...
					for(let j=-5; j<=5; j++){
						this.Pen.fillRect( widthHalf + i * this.scale, heightHalf + item1 - j,1,1 );
						this.Pen.fillRect( widthHalf - i * this.scale, heightHalf + item1 - j,1,1 );
						this.Pen.fillRect( widthHalf - j + item2, heightHalf - i * this.scale,1,1 );
						this.Pen.fillRect( widthHalf - j + item2, heightHalf + i * this.scale,1,1 );
					}
				}
				}
				drawing(xL,yL,item1,item2) {
					const widthHalf = Number(this.width) / 2;
					const heightHalf = Number(this.height) / 2;
					this.Pen.fillRect( widthHalf + item1 + xL*this.scale, heightHalf + item2 - yL*this.scale, 1,1);
				}
